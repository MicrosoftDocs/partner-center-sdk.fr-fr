...
| Nom                | Tapez             | Obligatoire | Description                                          |
|---------------------|------------------|----------|------------------------------------------------------|
| Id                  | chaîne           | N        | The order ID.                                        |
| ReferenceCustomerId | chaîne           | Y        | The customer ID.                                     |
| LineItems           | array of objects | Y        | An array of [OrderLineItem](#orderlineitem) objects. |
| CreationDate        | chaîne           | N        | The date the order was created, in date-time format. |
| Attributs          | object           | N        | Contains "ObjectType": "Order".                      |
...
| OfferId              | chaîne | Y        | The offer ID of the add-on.                                  |
| SubscriptionId       | chaîne | N        | The ID of the add-on subscription purchased.                 |
| ParentSubscriptionId | chaîne | Y        | The ID of the parent subscription that has the add-on offer. |
| friendlyName         | chaîne | N        | The friendly name for this line item.                        |
| Quantité             | nombre | Y        | The number of licenses.                                      |
| PartnerIdOnRecord    | chaîne | N        | The MPN ID of the partner of record.                         |
| Attributs           | object | N        | Contains "ObjectType": "OrderLineItem".                      |
