...
#### [Inscrire les détails de l’application pour l’Espace partenaires](create-apps-for-partner-center-for-microsoft-national-clouds.md)
...
### [Configurer un accès d’API dans l’espace partenaires](set-up-api-access-in-partner-center.md)
### [Authentification de l’espace partenaires](partner-center-authentication.md)
...
#### [Obtenir les abonnements d’un client par ID MPN de partenaire](get-all-subscriptions-by-partner.md)
...
#### [Obtenir les éléments de ligne de facture](get-invoiceline-items.md)
...
#### [Obtenir un compte utilisateur par ID](get-a-user-account-by-id.md)
...
#### [Obtenir les règles de mise en forme d’adresse par marché](get-market-specific-validation-data.md)
...
#### [Analyse](analytics-resources.md)
...
#### [Mettre à niveau](upgrade-resources.md)
#### [Utilisateur](user-resources.md)
#### [Ressources d’utilitaire](utility-resources.md)
### [Codes d’erreur REST d’Espace partenaires](error-codes.md) 
...
## [Informations de référence de l’API managée de l’Espace partenaires ](https://docs.microsoft.com/dotnet/api/?view=partnercenter-dotnet-latest)
## [Informations de référence de l’API Java de l’Espace partenaires ](https://docs.microsoft.com/java/partnercenter/overview?view=partnercenter-1.8.1)
