...
Pour mettre à jour un profil de facturation de partenaire, récupérez le profil existant. Une fois que vous avez mis à jour le profil, utilisez votre collection **collection iaggregatepartner. Profiles** et appelez la propriété **BillingProfile** . Enfin, appelez la méthode **Update ()** .
