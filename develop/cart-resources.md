...
|-----------------------|------------------|--------------------------------------------------------------------------------------------------------|
| id                    | chaîne           | A cart identifier that is supplied upon successful creation of the cart.                               |
...
| lastModifiedUser      | chaîne           | The user who last updated the cart. Applied upon successful creation of cart.                          |
| lineItems             | Array of objects | An Array of [CartLineItem](#cartlineitem) resources.                                                   |
| status                | chaîne           | The status of the cart. Possible values are "Active" (can be updated/submitted) and "Ordered" (has already been submitted). |
...
| catalogItemId        | chaîne                           | The catalog item identifier.                                                                                                                          |
...
| orderGroup           | chaîne                           | A group to indicate which items can be submitted together in the same order.                                                                          |
...
| errorDescription | chaîne                                 | The error description, including any notes about supported values, default values, or limits. |
...
| Propriété     | Tapez   | Description                                     |
|--------------|--------|-------------------------------------------------|
| orderGroupId | chaîne | The order group ID of the order with the error. |
| code         | entier    | The error code.                                 |
| description  | chaîne | The description of the error.                   |
