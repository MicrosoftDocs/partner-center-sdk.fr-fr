...
|    participants     | List of Object String pairs |    non    |                                                                A collection of PartnerId on Record (MPNID) on the purchase.                                                                 |
...
|     renewsTo        | Array of objects            |    non    |                                                    An array of [RenewsTo](cart-resources.md#renewsto) resources.                                                                            |
