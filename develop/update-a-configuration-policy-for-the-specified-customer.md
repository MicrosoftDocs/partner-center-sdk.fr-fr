...
| policy-id   | chaîne | Oui      | A GUID-formatted string that identifies the policy to update. |
...
| Nom            | Tapez             | Obligatoire | Updatable | Description                                                                                                                                              |
|-----------------|------------------|----------|-----------|----------------------------------------------------------------------------------------------------------------------------------------------------------|
| id              | chaîne           | Oui      | non        | The GUID-formatted string that identifies the policy.                                                                                                    |
| name            | chaîne           | Oui      | Oui       | The friendly name of the policy.                                                                                                                         |
| catégorie        | chaîne           | Oui      | non        | The policy category.                                                                                                                                     |
| description     | chaîne           | non       | Oui       | The policy description.                                                                                                                                  |
| devicesAssigned | nombre           | non       | non        | The number of devices.                                                                                                                                   |
| policySettings  | array of strings | Oui      | Oui       | The policy settings: "none","remove\_oem\_preinstalls","oobe\_user\_not\_local\_admin","skip\_express\_settings","skip \_oem\_registration,"skip\_eula". |
