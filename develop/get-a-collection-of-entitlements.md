...
|------|------|----------|-------------|
| customerId | chaîne | Oui | A GUID formatted customerId that identifies the customer. |
| entitlementType | chaîne | non | Can be used to specify the type of entitlements to be retrieved (**software** or **reservedInstance** ). If not set, all types will be retrieved |
| showExpiry | booléen | non | Optional flag which indicates if entitlements exipry dates are required. |
